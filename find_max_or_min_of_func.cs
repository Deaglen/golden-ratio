...
namespace WindowsFormsApp1
{
    class find_max_or_min_of_func
    {
        ...
        public find_max_or_min_of_func(double a, double b, double eps, ICulc culc)
        {
            this.a = a;
            this.b = b;
            this.eps = eps;
    ...
    public interface ICulc
    {
        ...
        string do_calc(double a, double b, double eps, bool max);
    }

    public class GoldenRatio : ICulc
    {
        public string do_calc(double a, double b, double eps, bool max)
        {
