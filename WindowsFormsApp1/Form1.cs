...
namespace WindowsFormsApp1
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                type = 2;
                find_max_or_min_of_func A = new find_max_or_min_of_func();
                Tuple<double, double> a1 = A.do_calc(a, b, eps, new Fibonacci(), type, max);
                string text = "x = " + a1.Item1 + "\n" + "f(x) = " + a1.Item2;
                MessageBox.Show(text);
            }
            else
            {
                find_max_or_min_of_func A = new find_max_or_min_of_func();
                Tuple<double, double> a1 = A.do_calc(a, b, eps, new GoldenRatio(), type, max);
                string text = "x = " + a1.Item1 + "\n" + "f(x) = " + a1.Item2;
                MessageBox.Show(text);
            }
